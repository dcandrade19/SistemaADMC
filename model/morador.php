...
class morador {
    ...
    static function getAll($status = 2){
        ...
        $result = $dbh->query("SELECT id FROM moradores $complemento ORDER BY id DESC");
    ...
    static function search($keyword = "", $status = 2){
        ...
        $dbh = dataBase::getHandler();
        $result = $dbh->query("SELECT id FROM moradores $complemento nome LIKE '%$keyword%' ORDER BY id DESC");
